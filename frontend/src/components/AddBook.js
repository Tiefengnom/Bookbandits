...
function AddBook() {
    ...
    return (
        <div>
            ...
            <button onClick={(e) => setStartScan(false)} className=' bg-white bg-opacity-60 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight uppercase rounded-full hover:bg-pink-600 hover:bg-opacity-[45%] focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Stop Scan</button>
            ...
            <form className='search-form' onSubmit={handleSubmit}>
                ...
                <button type='submit' className=' bg-white bg-opacity-60 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight uppercase rounded-full hover:bg-pink-600 hover:bg-opacity-[45%] focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Search </button>
            </form>
                              ...
                              return (
                                  <div key={b.id}>
                                      ...
                                      <form
                                          ...
                                          />
                                          <button type='submit' className=' bg-white bg-opacity-60 px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight uppercase rounded-full hover:bg-pink-600 hover:bg-opacity-[45%] focus:outline-none focus:ring-0 transition duration-150 ease-in-out cursor:pointer m-2'>Add to my books</button>
                                      </form>
                                  </div>
                              );
                          })
