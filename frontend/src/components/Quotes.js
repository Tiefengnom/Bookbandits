...
const [quote, setQuote]=useState()
  ...
  return (
    <div className="flex justify-center">
     ...
     <div class="max-w-4xl text-gray-800 bg-white bg-opacity-10 mt-8 px-16 rounded-lg shadow">
     <div class="mt-4 h-3 text-5xl text-left text-gray-600 font-bold font-serif">“</div>

         <h3 className="mt-4 text-left">{quote?.quote}</h3>
         <div class="h-3 text-5xl text-right text-gray-600 font-bold font-serif">”</div>

          <p className="m-t4 text-left">{quote?.author}</p> 
