            ...
            {!user ? (
                <div className="mt-6 mb-6">
                    ...
                    <button
                        ...
                        className='m-3 inline-block px-6 py-2 border-2 border-white-500  font-medium text-xs leading-tight uppercase rounded-full hover:bg-pink-600 hover:bg-opacity-[45%] focus:outline-none focus:ring-0 transition duration-150 ease-in-out'>
                        Login
                    </button>
                </div>
            ) : (
